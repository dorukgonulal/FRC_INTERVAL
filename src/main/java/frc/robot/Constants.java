...
public final class Constants {
    ...
    public static final class Swerve {
        ...
        public static final double angleKP = 8.5; //steering ayarlama
        ...
        public static final class Mod0 { //done
          ...
          public static final Rotation2d angleOffset = Rotation2d.fromDegrees(158);//-113 //67  tamalandı
        ...
        public static final class Mod1 { //done
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(360+116.5+52); //132.75 //-47.25 tamamlandı
            public static final SwerveModuleConstants constants = 
                new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
        ...
        public static final class Mod2 { //done
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(360-120.5+24);//-39.25 //140.75
            public static final SwerveModuleConstants constants = 
                new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
        ...
        public static final class Mod3 { //done
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(360+13.5-32);//154.75 //-25.25
            public static final SwerveModuleConstants constants = 
                new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
    }
    ...
    public static final class Intake {
      ...
      public static final int TOP_ROLLER_ID = 28; // doğrulandı
    ...
    public static final class Elevator {
      public static final int ELEVATOR_LEFT_MOTOR = 29; // doğrılandı
      public static final int ELEVATOR_RIGHT_MOTOR = 25; // doğrulandı
    }
    ...
    public static final class ElevatorConstants{
      ...
      public static final class PivotConstants {
        ...
        public static final double AMP_SHOOT_SETPOINT = -7; // TODO: this might be tuned specific // 15.6
    ...
    public static final class IOConstants {
        ...
        public static final double k_CONTROLLER_DEADBAND = 0;
